...
def split_data(input_csv, test_size, val_size, unseen_size):
    ...
    train_df, temp_df = train_test_split(data_df, test_size=(test_size + val_size), random_state=42)
...
if __name__ == "__main__":
    ...
    split_data("data/processed/data.csv", args.test_size, args.val_size, args.unseen_size)
